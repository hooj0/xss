...
public abstract class InjectedRejectorUtils {
	...
	static {
		...
		rejectores.put(JavaScriptInjectedRejector.getInstance().name, JavaScriptInjectedRejector.getInstance());
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("##" + InjectedRejectorUtils.invokeAll("masget/pay/weixin.do", "name", sql));
		System.out.println("##" + InjectedRejectorUtils.invokeAll("masget/pay/weixin.do", "remark", sql));
	}
}
