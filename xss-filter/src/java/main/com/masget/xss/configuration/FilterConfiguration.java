...
import com.masget.xss.configuration.factory.PropertyLoaderFactory;
...
public class FilterConfiguration extends AbstractResourceStreamLoader implements PropertyLoader {
	...
	public static void main(String[] args) {
		System.out.println(FilterConfiguration.getInstance().getObjectProp("masget/pay/weixin.do"));
		System.out.println(FilterConfiguration.getInstance().getMapProp("masget/pay/weixin.do"));
		System.out.println(FilterConfiguration.getInstance().getFilterProp("masget/pay/weixin.do"));
		System.out.println(FilterConfiguration.getInstance().getIncludeProp("masget/pay/weixin.do"));
		System.out.println(FilterConfiguration.getInstance().getExcludeProp("masget/pay/weixin.do"));
	}
}
