...
import com.cnblogs.hoojo.xss.configuration.manager.PropertyManager;
...
public class PropertyConfiguration extends AbstractResourceStreamLoader implements PropertyLoader {
	 ...
	 * com.cnblogs.hoojo.xss.opsteam system property 2.) In file defined as com.cnblogs.hoojo.xss.devteam system property 3.) In
	 * xss.properties
	 */
	@Override
	 ...
	 * 1.) In file defined as com.cnblogs.hoojo.xss.opsteam system property 
	 * 2.) In file defined as com.cnblogs.hoojo.xss.devteam system property 
	 * 3.) In xss.properties
	 */
	@Override
	 ...
	 * 1.) In file defined ascom.cnblogs.hoojo.xss.opsteam system property 
	 * 2.) In file defined as com.cnblogs.hoojo.xss.devteam system property 
	 * 3.) In xss.properties
	 */
	@Override
